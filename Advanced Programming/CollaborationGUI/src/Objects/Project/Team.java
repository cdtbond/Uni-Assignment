...
public class Team extends Project implements Serializable, Comparable{
	...
	private static int maxStudents = 4;
	...
	public void computeAverageSkillCompetency() {
		double anSkill = 0.00;
	...
	public void setFirstAndSecondPrefsPercent(int firstAndSecondPrefsCount, int size) {
		double prefCount = firstAndSecondPrefsCount;
		this.firstAndSecondPrefsPercent = Calculations.round2DecPl(prefCount / size);
	}
	...
	public int compareTo(Object o) {
		long value = Math.round(((this.of.getObjectiveValue() - ((Team) o).of.getObjectiveValue()))*100);
		int val2 = (int) value;
		return val2;
	}
