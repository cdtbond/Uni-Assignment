...
public class AssignStudentsViaObjectiveFunction {
	...
	public HashMap<String,ProjectObjectiveFunction> assignProjectGreedyAlgorithm(ArrayList<MatchTeamWithMembers> matches) throws IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
