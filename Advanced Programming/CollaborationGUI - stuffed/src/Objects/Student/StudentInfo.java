...
public class StudentInfo extends Student {
	...
	public StudentInfo(Student stud, char personalityType, String enemyStudentOne, String enemyStudentTwo) throws  IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
	...
	//two enemy students
	public StudentInfo(String studId,Integer progRank, Integer anRank, Integer netRank, Integer webRank, char personalityType, String enemyStudentOne, String enemyStudentTwo) throws  IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
	...
	public StudentInfo(String studId,Integer progRank, Integer anRank, Integer netRank, Integer webRank, char personalityType, String enemyStudentOne) throws  IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
		super(studId, progRank,anRank,netRank,webRank);
		this.setPersonality(new PersonalityType(personalityType));
		//can't do a check of other students in case they are entered later
		this.difficultStudents.add(enemyStudentOne);
	...
	//No enemy student
	public StudentInfo(String studId,int progRank, int anRank, int netRank, int webRank, char personalityType) throws  IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
		super(studId, progRank,anRank,netRank,webRank);
		this.setPersonality(new PersonalityType(personalityType));
	...
	public StudentInfo(Student stud, char personalityType, String enemyStudentOne) throws IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
		super(stud.getID(), stud.getSkills());
		this.setPersonality(new PersonalityType(personalityType));
	...
	public StudentInfo(Student stud, char personalityType) throws IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, IDOutOfRangeException {
		super(stud.getID(), stud.getSkills());
		this.setPersonality(new PersonalityType(personalityType));
				
	}
	
	public StudentInfo(StudentInfo stud) throws IDOutOfRangeException {
		super(stud.getID(),stud.getSkills());
