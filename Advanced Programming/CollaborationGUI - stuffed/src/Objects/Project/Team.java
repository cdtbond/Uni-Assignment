...
public class Team extends Project implements Serializable{
	...
	public Team(Project proj,StudentInfoWithPrefs s1, StudentInfoWithPrefs s2,StudentInfoWithPrefs s3,StudentInfoWithPrefs s4) throws StudentConflictException, PersonalityImbalanceException, RepeatedMemberException, NoLeaderException, IDOutOfRangeException {
		super(proj);
		members.add(s1);
		members.add(s2);
		members.add(s3);
	...
	public Team(Project proj, StudentInfoWithPrefs s1, StudentInfoWithPrefs s2,StudentInfoWithPrefs s3, StudentInfoWithPrefs s4, boolean b) throws IDOutOfRangeException {
		super(proj);
		members.add(s1);
		members.add(s2);
		members.add(s3);
	...
	public Team(Project proj, ArrayList<StudentInfoWithPrefs> studs) throws IDOutOfRangeException {
		super(proj);
	...
	protected void computeSkillShortfall() {
		double anSkill;
		double netSkill;
		double progSkill;
		double webSkill;
	...
	protected void computeAverageSkillCompetency() {
		double anSkill = 0.00;
	...
	protected void computeFirstAndSecondPrefs(ArrayList<StudentInfoWithPrefs> preferences) {
	...
	public String getSuitabilityMetrics() {
		...
		outString += getFirstAndSecondPrefsPercent();
		outString += "% \n";
		outString += "Average Skill competency is: ";
		outString += getAverageSkillCompetency();
		outString += "Skill shortfall is: ";
		outString += getSkillShortfall();
	...
	public void recalculateMetrics() {
		computeAverageSkillCompetency();
		computeFirstAndSecondPrefs(getMembers());
		computeSkillShortfall();
	}
