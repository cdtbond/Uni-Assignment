...
public class Project extends ParentObject {
	...
	public Project(String ID, String title,String description,String ownerId, Integer progRank, Integer anRank, Integer netRank, Integer webRank) throws IncorrectRankException, IncorrectRangeException, IDOutOfRangeException {
		super(ID);
		this.setTitle(title);
	...
	public Project(Project proj) throws IDOutOfRangeException {
		super(proj.getID());
