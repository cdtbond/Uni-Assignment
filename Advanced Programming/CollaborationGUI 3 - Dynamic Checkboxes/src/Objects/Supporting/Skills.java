...
public class Skills implements Serializable{
	...
	public Skills(Integer progValue, Integer netValue, Integer anValue, Integer webValue) throws IncorrectRangeException {
		...
		Skill net = new netSkill((double)netValue);
		Skill an = new anSkill((double)anValue);
		Skill web = new webSkill((double)webValue);
	...
	public Skills(double progSkill, double netSkill, double anSkill, double webSkill) {
		...
		Skill net = new netSkill(netSkill);
		Skill an = new anSkill(anSkill);
		Skill web = new webSkill(webSkill);
