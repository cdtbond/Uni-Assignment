...
public class HandleFile {
	...
	public void writeAllFiles(HashMaps hm) {
	...
	public void loadTxtInput(HandleFile hf, HandleSerialization hs) {
		...
		Stream<String> rows = Files.lines(Paths.get("students.txt"));
	      ...
	      .collect(Collectors.toMap(x -> x[0],
	          x -> {
				...
				} catch (NumberFormatException | IncorrectRangeException e) {
					e.printStackTrace();
					return null;
				}
			}));
		...
		Stream<String> rows = Files.lines(Paths.get("companies.txt"));
	      ...
	      .collect(Collectors.toMap(x -> x[0],
	          x -> {
				...
				} catch (NumberFormatException | ABNValuesIncorrectException | ABNLengthIncorrectException e) {
					e.printStackTrace();
					return null;
				}
			}));
		...
		Stream<String> rows = Files.lines(Paths.get("studentinfo.txt"));
	      ...
	      .collect(Collectors.toMap(x -> x[0],
	          x -> {
				...
				} catch (NumberFormatException | IncorrectPersonalityTypeException | IncorrectGradeException | IncorrectRangeException e) {
					e.printStackTrace();
					return null;
				}
			}));
		...
		Stream<String> rows = Files.lines(Paths.get("projects.txt"));
	      ...
	      .collect(Collectors.toMap(x -> x[0],
	          x -> {
				...
				} catch (NumberFormatException | IncorrectRankException | IncorrectRangeException e) {
					e.printStackTrace();
					return null;
				}
			}));
