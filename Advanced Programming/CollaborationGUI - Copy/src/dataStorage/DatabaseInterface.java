...
public class DatabaseInterface {
	private static HashMaps h1 = new HashMaps();
...
public void insertAllObjectsIntoSQL(HashMaps hm) {
	   	insertAllStudents(hm.getStudentInfoWithPrefs());
...
private static void createCompanies() {
   ...
   private static void createStudents() {
	   ...
	   } catch (IncorrectPersonalityTypeException | IncorrectGradeException | IncorrectRangeException | SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	   }   		   
}
