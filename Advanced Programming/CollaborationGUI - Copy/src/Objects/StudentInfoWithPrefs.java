...
public class StudentInfoWithPrefs extends StudentInfo{
	...
	public StudentInfoWithPrefs(ResultSet rs) throws IncorrectPersonalityTypeException, IncorrectGradeException, IncorrectRangeException, SQLException {
		super("S" + rs.getInt("ID"),rs.getInt("ProgRank"),rs.getInt("AnRank"),rs.getInt("NetRank"),rs.getInt("WebRank"),rs.getString("PersonalityType").charAt(0),"S"+rs.getString("DifficultStudent1"),"S"+rs.getString("DifficultStudent2"));		
