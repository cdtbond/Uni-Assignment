...
public class AssignStudentsViaObjectiveFunction {
	...
	private boolean betterOFOutcome(HashMap<String,ProjectObjectiveFunction> assignedLeaders, String studentId, double newObjectiveValue) {
		return assignedLeaders.get(studentId).getObjectiveFunction() > newObjectiveValue;
	}
