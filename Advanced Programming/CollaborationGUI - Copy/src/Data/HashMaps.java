...
import Objects.AssignStudentsViaObjectiveFunction;
import Objects.Company;
import Objects.MatchTeamWithMembers;
import Objects.ObjectiveFunction;
import Objects.Owner;
import Objects.Preferences;
import Objects.Project;
import Objects.ProjectObjectiveFunction;
import Objects.Student;
import Objects.StudentInfo;
import Objects.StudentInfoWithPrefs;
import Objects.Team;
import OtherObjects.PrefCount;
import OtherObjects.PrefCountSorter;
import OtherObjects.Skills;
import OtherObjects.StandardDeviation;
...
public class HashMaps implements Serializable, Cloneable {
	...
	public void addTeam(Team team) throws InvalidMemberException {
	   ...
	   public ArrayList<StudentInfoWithPrefs> getStudentInfoWithPrefs() {
	...
	private HashMap<String, ProjectObjectiveFunction> addleaderStudents(ArrayList<Double> objWeights, HashMap<String, StudentInfoWithPrefs> unassignedStuds) {
	...
	private HashMap<String,ProjectObjectiveFunction> addStudents(ArrayList<Double> objWeights,HashMap<String, StudentInfoWithPrefs> unassignedStuds) {
	...
	public String autoCalculateObjectiveFunction(double skillShortfall,double averageCompetency, double firstAndSecondPrefs ) {
		
		ArrayList<Double> objWeights = addObjectiveWeightsToFunction(skillShortfall, averageCompetency, firstAndSecondPrefs);
		...
		// leaders
		HashMap<String, ProjectObjectiveFunction> leaders = addleaderStudents(objWeights,unassignedStuds);
		HashMap<String, ProjectObjectiveFunction> secondStudent = addStudents(objWeights,unassignedStuds);
		HashMap<String, ProjectObjectiveFunction> thirdStudent = addStudents(objWeights,unassignedStuds);
		HashMap<String, ProjectObjectiveFunction> fourthStudent = addStudents(objWeights,unassignedStuds);
		...
		double newObjValue = calculateObjectiveFunction(objWeights, tempTeams);
		System.out.println("New Objective Value - " + newObjValue);
		
		//let controller decide to submit or not
		return stringAlgorithmsOutput(newObjValue, objWeights);
	}	
	...
	private String stringAlgorithmsOutput(double newObjectiveFunction, ArrayList<Double> functionWeights) {
	...
	private double calculateObjectiveFunction(ArrayList<Double> functionValues, HashMap<String,Team> t) {
		calculateAverageGrade();
